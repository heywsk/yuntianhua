        ...
        return (
            <div>
                <div className="fu-container bg-xzpiypc cbg">
                   ...
                   <div className="ant-col  ant-col-xs-24 ant-col-md-4"></div>
                   <div className="ant-col  ant-col-xs-24 ant-col-md-6">
                        <div class="item-pic"><img src={require('../imgs/bntx5.png')} /></div>
                   </div>
                   </div>
